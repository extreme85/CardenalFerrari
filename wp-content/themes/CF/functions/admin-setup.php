...
function themnificthemes_admin_head() { 
    ...
    jQuery(function(){
        ...
        var message = '<p>This <strong>Vergo</strong> comes with a <a href="<?php echo admin_url('admin.php?page=themnificthemes'); ?>">comprehensive options panel</a>. This theme also supports widgets, please visit the <a href="<?php echo admin_url('widgets.php'); ?>">widgets settings page</a> to configure them.</p>';
