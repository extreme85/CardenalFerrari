...
class tmnf_Homepage_Gallery_Widget extends WP_Widget {
	...
	function tmnf_Homepage_Gallery_Widget()
	{
		...
		$this->WP_Widget('tmnf_homepage_gallery', 'Themnific - Home: Gallery', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		?>
			...
			<h2 class="widget"><a href="<?php echo esc_url(get_category_link($categories)); ?>"><span><i class="icon-picture"></i> <?php echo $title; ?></span></a>
            </h2>
			<?php
