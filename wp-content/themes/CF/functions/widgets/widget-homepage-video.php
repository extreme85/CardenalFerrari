...
class featured_tabs_widget extends WP_Widget {
	...
	function Featured_Tabs_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'featured_tabs_widget', __('Themnific - Home: Video', 'themnific'), $widget_ops );
	...
	function widget($args, $instance)
	{
		...
		?>
			...
			<h2 class="widget"><a href="<?php echo get_category_link($categories); ?>"><span><i class="icon-youtube-play"></i> <?php echo $title; ?></span></a></h2>
